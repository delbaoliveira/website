...
For example, the following URL generated the image above:

<div className="break-words p-6 bg-white/5 rounded-xl my-4">
[https://res.cloudinary.com/delba/image/upload/w_1600,h_836,q_100/l_text:Karla_72_bold:Title...,co_rgb:ffe4e6,c_fit,w_1400,h_240/fl_layer_apply,g_south_west,x_100,y_180/l_text:Karla_48:Meta...,co_rgb:ffe4e680,c_fit,w_1400/fl_layer_apply,g_south_west,x_100,y_100/l_twitter_name:delba_oliveira/c_thumb,g_face,r_max,w_380,h_380,q_100/fl_layer_apply,w_140,g_north_west,x_100,y_100/grain-gradient.png](<https://res.cloudinary.com/delba/image/upload/w_1600,h_836,q_100/l_text:Karla_72_bold:Automatically%2520Generated%2520Branded%2520Open%2520Graph%2520(OG)%2520Images%2520for%2520Blog%2520Posts,co_rgb:ffe4e6,c_fit,w_1400,h_240/fl_layer_apply,g_south_west,x_100,y_180/l_text:Karla_48:delba.dev%2520%25C2%25B7%2520Oct%25201,co_rgb:ffe4e680,c_fit,w_1400/fl_layer_apply,g_south_west,x_100,y_100/l_twitter_name:delba_oliveira/c_thumb,g_face,r_max,w_380,h_380,q_100/fl_layer_apply,w_140,g_north_west,x_100,y_100/grain-gradient.png>)
</div>

This might look a bit complex at first but we will break it down below.

# Step 1: The Canvas

First, upload an image to your Cloudinary account that will be used as the base layer for the generated image.
...
const createOgImage = () => {
  return (
    [
      ...
      `https://res.cloudinary.com/delba/image/upload`,
      // transform image: width, height, quality
      `w_1600,h_836,q_100`,
      // base image: <cloudinary_public_id>
      `grain.png`,
    ]
...
<Aside side="right">
  ...
  <meta property="og:image" content="..." />` meta tag in the HTML of our pages.
</Aside>
