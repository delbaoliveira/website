---
title: "Day 2: A like button that likes you back"
description: "Inspired by Josh Comeau, I've recreated a like button that delightfully animates and persists state to a database. This is a case study of the process and breaks down how I did it."
...
I'm using `framer-motion` to scale the hearts size as the user interacts (hover and click) with the like button. Finally, I bumped the like count up using a `useState` hook.
