    ...
    >
      ...
      <div className="flex flex-wrap items-center">
        ...
        >
          ...
          <span
            className="text-lg font-bold text-rose-100/80 group-hover:underline group-hover:text-rose-100/90 group-hover:decoration-rose-100/50 group-hover:underline-offset-2"
            title={author.name}
          >
            {author.name}
          </span>
        ...
        <a
          className="text-rose-100/60 hover:underline hover:decoration-rose-100/50 hover:underline-offset-2 ml-1.5"
          href={tweetUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      {linkPreview ? (
        <div className="p-3 mt-4 rounded-xl bg-white/[2%] shadow-surface-elevation-low">
      ...
      {!type ? (
        <div className="flex mt-4 text-rose-100/50">
          {/* Replies */}
          <a
            className="flex items-center text-rose-100/50 w-28 hover:underline hover:decoration-rose-100/30 hover:underline-offset-2"
            href={replyUrl}
            target="_blank"
            rel="noopener noreferrer"
          >
