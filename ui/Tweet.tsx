    ...
    >
      ...
      <div className="flex flex-wrap items-center text-lg">
        ...
        >
          ...
          <span
            className="font-medium text-rose-100/80 group-hover:text-rose-100/90 group-hover:underline group-hover:decoration-rose-100/50 group-hover:underline-offset-2"
            title={author.name}
          >
            {author.name}
          </span>
        ...
        <a
          className="ml-1.5 text-rose-100/50 hover:underline hover:decoration-rose-100/30 hover:underline-offset-2"
          href={tweetUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      {/* Text */}
      <div className="mt-2 text-lg whitespace-pre-wrap text-rose-100/70">
        {text}
      </div>
      ...
      {!type ? (
        <div className="flex mt-4 text-rose-100/50">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <svg className="w-5 h-5 mr-3 text-rose-100/20" viewBox="0 0 24 24">
              <path
